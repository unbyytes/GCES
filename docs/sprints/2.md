...
* O Básico do CI/CD – A Fundação
    ...
    -  Objetivos Práticos: Estudar ferramentas para a implementação, escolhendo as melhores para o projeto EJ, e Adicionar e configurar pelo menos uma dessas ferramentas selecionadas, com o objetivo de praticar e também levantar ideias para a pipeline oficial      
