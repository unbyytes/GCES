...
| Identificação das práticas de GCES do projeto     | Concluído                           | – [📚 Práticas de GCES no EJ](#praticas-de-gces-no-ej)                                   | Documento atual |
| Configuração inicial do ambiente do EJ            | Pendente                            | - [⚙️ Configuração de Ambiente](#configuracao-de-ambiente)                               | Documento atual |
| Estudo sobre a infraestrutura da aplicação        | Concluído                            | - [🏗️ Infraestrutura](#infraestrutura)                                                   | Documento atual |
...
Assim que os contêineres estiverem rodando, a aplicação estará disponivel no seu navegador nesse endereço:
* `http://localhost:8000 ---`
